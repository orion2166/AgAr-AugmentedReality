...
public class GeoObjectController {
    ...
    public static World fillWorld(World world){
        ...
        GeoObject object11 = GeoObjectController.createGeoObject(11L,30.612789, -96.340312,"rudderuti1", R.drawable.restroom);
        GeoObject object12 = GeoObjectController.createGeoObject(12L,30.612377, -96.340576,"mscresturant", R.drawable.resturant);
        GeoObject object13 = GeoObjectController.createGeoObject(13L,30.612760, -96.340365,"rudderservice", R.drawable.theater);
        GeoObject object14 = GeoObjectController.createGeoObject(14L,30.612313, -96.340639,"mscuti1", R.drawable.restroom);
